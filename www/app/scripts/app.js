...
$rootScope.App.Name = "Nueva app1 (Created with an unregistered version of App Builder)";
$rootScope.App.Version = "1.0.0";
$rootScope.App.Description = "Otra app the App Builder";
...
$rootScope.App.Theme = "Bootstrap4-3D";
$rootScope.App.Themes = ["Bootstrap3-3D"];
if ($rootScope.App.Themes.indexOf("Bootstrap4-3D") == -1) { $rootScope.App.Themes.push("Bootstrap4-3D"); }
    };
...
$rootScope.pNum = {};
$rootScope.pNum.ABRole = 3002;
$rootScope.pNum.Hidden = "";
$rootScope.pNum.Value = 0;
$rootScope.pNum.Title = "";
$rootScope.pNum.TabIndex = 2;
$rootScope.pNum.TooltipText = "";
$rootScope.pNum.TooltipPos = "top";
$rootScope.pNum.PopoverText = "";
$rootScope.pNum.PopoverEvent = "mouseenter";
$rootScope.pNum.PopoverTitle = "";
$rootScope.pNum.PopoverPos = "top";
$rootScope.pNum.PlaceHolder = "";
$rootScope.pNum.Class = "form-control input-lg ";
$rootScope.pNum.Disabled = "";
$rootScope.pNum.Required = "true";
$rootScope.pNum.ReadOnly = "";

$rootScope.sNum = {};
$rootScope.sNum.ABRole = 3002;
$rootScope.sNum.Hidden = "";
$rootScope.sNum.Value = 0;
$rootScope.sNum.Title = "";
$rootScope.sNum.TabIndex = 1;
$rootScope.sNum.TooltipText = "";
$rootScope.sNum.TooltipPos = "top";
$rootScope.sNum.PopoverText = "";
$rootScope.sNum.PopoverEvent = "mouseenter";
$rootScope.sNum.PopoverTitle = "";
$rootScope.sNum.PopoverPos = "top";
$rootScope.sNum.PlaceHolder = "";
$rootScope.sNum.Class = "form-control input-lg ";
$rootScope.sNum.Disabled = "";
$rootScope.sNum.Required = "true";
$rootScope.sNum.ReadOnly = "";

$rootScope.btn_suma = {};
$rootScope.btn_suma.ABRole = 2001;
$rootScope.btn_suma.Hidden = "";
$rootScope.btn_suma.Title = "";
$rootScope.btn_suma.TabIndex = 3;
$rootScope.btn_suma.TooltipText = "";
$rootScope.btn_suma.TooltipPos = "top";
$rootScope.btn_suma.PopoverText = "";
$rootScope.btn_suma.PopoverTitle = "";
$rootScope.btn_suma.PopoverEvent = "mouseenter";
$rootScope.btn_suma.PopoverPos = "top";
$rootScope.btn_suma.Badge = "";
$rootScope.btn_suma.Icon = "";
$rootScope.btn_suma.Text = "Sumar";
$rootScope.btn_suma.Class = "btn btn-default btn-lg ";
$rootScope.btn_suma.Disabled = "";

$rootScope.Label1 = {};
$rootScope.Label1.ABRole = 6002;
$rootScope.Label1.Hidden = "";
$rootScope.Label1.Class = "";
$rootScope.Label1.Text = "SUMA DOS NUMEROS";
...
$rootScope.Result = {};
$rootScope.Result.ABRole = 3002;
$rootScope.Result.Hidden = "";
$rootScope.Result.Value = 0;
$rootScope.Result.Title = "";
$rootScope.Result.TabIndex = 4;
$rootScope.Result.TooltipText = "";
$rootScope.Result.TooltipPos = "top";
$rootScope.Result.PopoverText = "";
$rootScope.Result.PopoverEvent = "mouseenter";
$rootScope.Result.PopoverTitle = "";
$rootScope.Result.PopoverPos = "top";
$rootScope.Result.PlaceHolder = "";
$rootScope.Result.Class = "form-control input-lg ";
$rootScope.Result.Disabled = "";
$rootScope.Result.Required = "";
$rootScope.Result.ReadOnly = "true";
    };
...
$scope.btn_sumaClick = function($event) {
$rootScope.btn_suma.Event = $event;

$rootScope.Result.Value = parseFloat($rootScope.pNum.Value+$rootScope.sNum.Value);
